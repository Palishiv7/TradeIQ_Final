  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-6 bg-gray-50">
      <div className="w-full max-w-lg bg-white rounded-xl p-8 shadow-md text-center">
        <div className="w-16 h-16 rounded-full bg-purple-100 text-purple-600 text-3xl flex items-center justify-center mx-auto mb-4">
          🧠
        </div>
        <h1 className="text-3xl font-bold mb-4">Market Psychology Assessment</h1>
